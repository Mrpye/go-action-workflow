...
type Action struct {
	...
	Fail            string                 `json:"fail,omitempty" yaml:"fail,omitempty"`
	ContinueOnError interface{}            `json:"continue_on_error,omitempty" yaml:"continue_on_error,omitempty"`
	Config          map[string]interface{} `json:"config" yaml:"config"`
	Disabled        interface{}            `json:"disabled,omitempty" yaml:"disabled,omitempty"`
}
